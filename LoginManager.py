...
download_update = "https://github.com/Shiggyyy/MultiTool/blob/main/update.py"
response = requests.get("https://raw.githubusercontent.com/Shiggyyy/MultiTool/main/update.json")
data = response.text
